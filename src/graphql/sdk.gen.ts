...
export const GetAllMoviesDocument = gql`
	query GetAllMovies(
		...
		$last: Int
		$before: String
		$where: MediaItemFilterInput
		$order: [MediaItemSortInput!]
	) {
		mediaItems(
			first: $first
			after: $after
...
export const GetAllBoxSetsDocument = gql`
	query GetAllBoxSets(
		...
		$last: Int
		$before: String
		$where: BoxsetFilterInput
		$order: [BoxsetSortInput!]
	) {
		boxsets(
			first: $first
			after: $after
...
export function getSdk(
	...
	return {
		...
		): Promise<GetAllMoviesQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetAllMoviesQuery>({
						document: GetAllMoviesDocument,
						variables,
		...
		GetAllSeries(
			variables?: GetAllSeriesQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders,
			signal?: RequestInit['signal'],
		): Promise<GetAllSeriesQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetAllSeriesQuery>({
						document: GetAllSeriesDocument,
						variables,
						requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
						signal,
					}),
		...
		GetMovieBySlug(
			variables: GetMovieBySlugQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders,
			signal?: RequestInit['signal'],
		): Promise<GetMovieBySlugQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetMovieBySlugQuery>({
						document: GetMovieBySlugDocument,
						variables,
						requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
						signal,
					}),
		...
		GetSeriesBySlug(
			variables: GetSeriesBySlugQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders,
			signal?: RequestInit['signal'],
		): Promise<GetSeriesBySlugQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetSeriesBySlugQuery>({
						document: GetSeriesBySlugDocument,
						variables,
						requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
						signal,
					}),
		...
		GetAllBoxSets(
			variables?: GetAllBoxSetsQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders,
			signal?: RequestInit['signal'],
		): Promise<GetAllBoxSetsQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetAllBoxSetsQuery>({
						document: GetAllBoxSetsDocument,
						variables,
						requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
						signal,
					}),
		...
		GetBoxSetBySlug(
			variables: GetBoxSetBySlugQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders,
			signal?: RequestInit['signal'],
		): Promise<GetBoxSetBySlugQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetBoxSetBySlugQuery>({
						document: GetBoxSetBySlugDocument,
						variables,
						requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
						signal,
					}),
...
export type GetAllBoxSetsQuery = {
	__typename?: 'Query';
	boxsets?: {
		__typename?: 'BoxsetsConnection';
		edges?: Array<{
			...
			node: {
				...
				title?: string | null;
				type: string;
				release?: { __typename?: 'Release'; year: number } | null;
			};
		}> | null;
		pageInfo: {
			__typename?: 'PageInfo';
...
export type GetBoxSetBySlugQuery = {
	__typename?: 'Query';
	boxsets?: {
		__typename?: 'BoxsetsConnection';
		edges?: Array<{
